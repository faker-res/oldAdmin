          ...
          <i-col class="c_search_top" span="24">
            <Card dis-hover>
              <i-form :model="DataSearch" inline>
                ...
                <!-- <FormItem label="会员记录">
                  <TableNameSelect ref="TableNameSelect" @listenOnChange="tableChange" :TableNameSelectData="TableNameSelectOfMemberLog"></TableNameSelect>
                </FormItem> -->
                <FormItem label="每页条数">
                  <Select v-model="DataSearch.limit" placeholder="选择" style="width:80px">
                ...
                <FormItem label="操作事件">
                  <Select clearable placeholder="选择" v-model="DataSearch.act" style="width: 80px">
      ...
      table: {
        ...
        TableColumn: [
          ...
          },
          {
            ...
            width: 410,
            render: (h, params) => {
              let text = params.row.actionInfo.slice(
                    0,9)+
                    params.row.actionInfo.slice(
        ...
        loading: true,
        align: "center",
        posturl: this.$root.HTTP_L.HTTP_HuiYuanRiZhiLieBiao,
        dataform: {
          isRules: "select",
