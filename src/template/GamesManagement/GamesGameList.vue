  ...
  data() {
    return {
      ...
      table: {
              ...
              return h(
                      ...
                      that.$Modal.confirm({
                        ...
                        onOk: () => {
                          if (params.row.close == "yes") {
                            that.$root.HTTP_ALLLINKGET(that.$root.HTTP_L.HTTP_JinYongYouXiPingTai+params.row.id)
                            // that.$root
                ...
                params.row.close == "yes" ? "关闭" : "开启"
                  ...
                  h('Button',{
                    ...
                    on:{
                      click: () => {
                        this.$router.push({name:'GamesPlatformDetails',query:{id:params.row.id,platform:params.row.platform}})
                      }
                    }
                  },'详情')
                ]
        ...
        loading: true,
        align: "center",
        posturl: this.$root.HTTP_L.HTTP_DianZiYouXiLieBiao,
        dataform: {
          // sitename:'站点名称啊啊'
        }
      }
